...
# 定义sft训练函数
def train_sft(config: SFTConfig, peft_config: LoraConfig=None) -> None:
    ...
    trainer = SFTTrainer(
        ...
        peft_config=peft_config,               #peft参数
    )
...
if __name__ == "__main__":
    ...
    train_sft(sft_config, peft_config=peft_config)